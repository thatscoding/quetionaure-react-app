      ...
      <div className="mx-1 sm:mx-0 lg:mx-4">
        ...
        <form onSubmit={onSubmit} className="flex flex-col">
          <div className="flex flex-col gap-2">
            <p>
              Question Name <span className="font-bold text-red-500">*</span>
            </p>
            <input
              {...register("QueName")}
          ...
          <div className="flex flex-col gap-2">
            <p>
              Question Type <span className="font-bold text-red-500">*</span>
            </p>
            <Select
          ...
          {isCheck && (
            <div className="flex flex-col gap-2 mt-2">
              <p>
                Select Answer <span className="font-bold text-red-500">*</span>
              </p>
              <Select
                options={selectedOptions}
